          ...
          <nav class="bg-gray-800">
                ...
                <div class="flex items-center">
                  ...
                  <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                      ...
                      <x-nav-links  href="/" aria-current="page" :active="request()->is('/')">Dashboard</x-nav-links>
                      <x-nav-links  href="/about" aria-current="page" :active="request()->is('about')">About</x-nav-links>
                      <x-nav-links  href="/contact" aria-current="page" :active="request()->is('contact')">Contact</x-nav-links>
                    </div>
                  </div>
                </div>
                <div class="hidden md:block">
            ...
            <el-disclosure id="mobile-menu" hidden class="block md:hidden">
              <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
                ...
                <a href="/about" class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg白/5 hover:text-white">About</a>
